...
public partial class InventoryWarehouseTransactionReturn
{
    public long InventoryWarehouseTransactionReturnId { get; set; }

    public string InventoryWarehouseDocumentNumber { get; set; } = null!;
