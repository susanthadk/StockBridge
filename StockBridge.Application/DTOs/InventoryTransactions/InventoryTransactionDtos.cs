...
public class InventoryLineTransactionDto
{
...
public class InventoryHeaderTransactionDto
{
    ...
    public List<InventoryLineTransactionDto> InventoryLineTransactions { get; set; } = new List<InventoryLineTransactionDto>();
}