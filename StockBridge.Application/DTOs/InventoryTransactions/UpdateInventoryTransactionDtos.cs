...
public class UpdateInventoryLineTransactionDto
{
...
public class UpdateInventoryHeaderTransactionDto
{
    [Required(ErrorMessage = "InventoryHeaderTransactionId is required.")]
    [Range(1, long.MaxValue, ErrorMessage = "InventoryHeaderTransactionId must be a positive value.")]
    ...
    public List<UpdateInventoryLineTransactionDto> InventoryLineTransactions { get; set; } = new List<UpdateInventoryLineTransactionDto>();
}