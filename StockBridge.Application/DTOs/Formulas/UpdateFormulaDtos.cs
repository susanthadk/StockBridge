...
public class UpdateFormulaHeaderDto
{
    [Required(ErrorMessage = "FormulaHeaderId is required.")]
    [Range(1, int.MaxValue, ErrorMessage = "FormulaHeaderId must be a positive value.")]
    ...
    public List<UpdateFormulaLineDto> FormulaLines { get; set; } = new List<UpdateFormulaLineDto>();
}