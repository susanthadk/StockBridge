...
public class VoucherInventoryLineDto
{
...
public class VoucherInventoryHeaderDto
{
    ...
    public List<VoucherInventoryLineDto> VoucherInventoryLines { get; set; } = new List<VoucherInventoryLineDto>();
}