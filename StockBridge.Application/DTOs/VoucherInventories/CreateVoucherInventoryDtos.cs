...
public class CreateVoucherInventoryLineDto
{
...
public class CreateVoucherInventoryHeaderDto
{
    ...
    public List<CreateVoucherInventoryLineDto> VoucherInventoryLines { get; set; } = new List<CreateVoucherInventoryLineDto>();
}