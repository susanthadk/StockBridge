...
public class UpdateGoodsReceiptTemporaryDetailDto
{
...
public class UpdateGoodsReceiptTemporaryHeaderDto
{
    [Required(ErrorMessage = "GoodsReceiptTemporaryHeaderId is required.")]
    [Range(1, long.MaxValue, ErrorMessage = "GoodsReceiptTemporaryHeaderId must be a positive value.")]
    ...
    public List<UpdateGoodsReceiptTemporaryDetailDto> GoodsReceiptTemporaryDetails { get; set; } = new List<UpdateGoodsReceiptTemporaryDetailDto>();
}