...
public class GoodsReceiptTemporaryDetailDto
{
...
public class GoodsReceiptTemporaryHeaderDto
{
    ...
    public List<GoodsReceiptTemporaryDetailDto> GoodsReceiptTemporaryDetails { get; set; } = new List<GoodsReceiptTemporaryDetailDto>();
}